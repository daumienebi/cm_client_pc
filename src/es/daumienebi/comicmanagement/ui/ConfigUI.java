...
public class ConfigUI extends JDialog {
	...
	public static String ConfigUI_configValues = "Valores de conexi�n";
	public static String ConfigUI_saveError = "Es obligatorio indicar el Servidor principal";
	public static String ConfigUI_saved = "Valores guardados,reinicia la aplicaci�n para efectuar los cambios";
	...
	void Inicialize() {
		...
		ConfigUI_SaveSettings.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!txtApiServer.getText().isEmpty()) {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(10)
					.addComponent(separator, GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE)
					.addGap(10))
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(ConfigUI_Server, GroupLayout.PREFERRED_SIZE, 91, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(txtApiServer, GroupLayout.DEFAULT_SIZE, 527, Short.MAX_VALUE)
					.addGap(40))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(10)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(separator_1, GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE))
					.addGap(10))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(10)
					.addComponent(separator_1_1, GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE)
					.addGap(10))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(10)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(9)
							.addComponent(txtFtpUser, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(ConfigUI_FtpPassword, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(txtFtpPassword, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)))
					.addGap(38))
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(txtCollectionImgServer, GroupLayout.DEFAULT_SIZE, 525, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
							...
							.addGap(28)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(txtDbName, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
								.addComponent(txtDbPassword, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
								.addComponent(txtDbUser, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
								.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										.addComponent(ConfigUI_SaveSettings, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
										.addComponent(txtDbPort, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE))
									.addGap(2))
								.addComponent(ConfigUI_BaseDeDatos, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
								.addComponent(txtIp, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE)))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(10)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(txtComicImgServer, GroupLayout.DEFAULT_SIZE, 527, Short.MAX_VALUE))))
					.addGap(40))
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(separator_2, GroupLayout.DEFAULT_SIZE, 676, Short.MAX_VALUE)
					.addContainerGap())
		);
